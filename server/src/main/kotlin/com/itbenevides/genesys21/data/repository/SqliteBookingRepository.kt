...
class SqliteBookingRepository(
    ...
    override suspend fun deleteService(
        ...
        dbQuery {
            ...
            val storeId =
                BookingServicesTable.select(BookingServicesTable.storeId)
    ...
    override suspend fun getAvailability(storeId: String): MerchantAvailability =
        dbQuery {
            val availabilityRow =
                MerchantAvailabilityTable.selectAll().where { MerchantAvailabilityTable.storeId eq storeId }.singleOrNull()
            ...
            val weeklyConfigs =
                weeklyRows.groupBy { it[WeeklyAvailabilityTable.dayOfWeek] }.map { (day, rows) ->
                    DayConfig(
                        dayOfWeek = day,
            ...
            val blocked =
                BlockedDatesTable.selectAll().where { BlockedDatesTable.storeId eq storeId }.map {
            ...
            try {
                ...
                AppointmentsTable.selectAll().where { conditions }
                    .map { row ->
                        ...
                        val notes =
                            AppointmentNotesTable.selectAll()
                        ...
                        Appointment(
                            ...
                            address =
                                if (row[AppointmentsTable.zipCode] != null) {
                                    Address(
