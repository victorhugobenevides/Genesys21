...
class PageViewModelTest {
    ...
    @Test
    fun `saveDraft should persist page in draft repository`() = runTest {
    ...
    @Test
    fun `clearDraft should remove page from draft repository`() = runTest {
    ...
    @Test
    fun `savePage should refresh list and clear draft`() = runTest {
