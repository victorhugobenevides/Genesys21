...
object PageTemplateRegistry {
    ...
    private val legalProfessional get() =
        PageTemplate(
    ...
    private val creativePortfolio get() =
        PageTemplate(
            ...
            // Sharp edges for brutalist look
            customTheme = CustomThemeConfig(cornerRadius = 0),
            components =
                listOf(
    ...
    private val serviceBooking get() =
        PageTemplate(
            id = "service_booking",
    ...
    private val personalHub get() =
        PageTemplate(
            ...
            defaultTheme = PageThemeConfig.MONO,
            // Ultra-rounded buttons
            customTheme = CustomThemeConfig(cornerRadius = 50),
            components =
                listOf(
                    PageComponent.ProfileHeader(
